	...
	def write(
		...
		*,
		...
		with _get_writer(file_or_filename, enc_lower) as write:
			if method == "xml" and (
				xml_declaration
				or (xml_declaration is None and enc_lower not in ("utf-8", "us-ascii", "unicode"))
			):
	...
	*target* is an optional target object which defaults to an instance of the
	...
	def doctype(self, name, pubid, system):
		...
		*name* is the Doctype name, *pubid* is the public identifier,
		...
		"""
		warnings.warn(
			"This method of XMLParser is deprecated.  Define doctype() " "method on the TreeBuilder target.",
			DeprecationWarning,
		)
